...
@section('page_header')
    <div class="container-fluid">
        ...
        @endcan
        <a href="{{ route('brand.login') }}" target="_blank" class="btn btn-primary btn-add-new" style="margin-left: 10px;">
            <i class="voyager-camera"></i> <span>Escanear Código (Portal de Marcas)</span>
        </a>
